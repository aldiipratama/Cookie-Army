...
import { FolderClock, Home, MenuIcon, Book, PlusSquare, Search, User, LogOut, AlertTriangle, BookMarked, ActivitySquare, MenuSquare, MessageSquareIcon } from "lucide-react";
...
export default function AppSidebar() {
    ...
    return (
        <Sidebar variant="sidebar" collapsible="offcanvas">
            <SidebarContent className="flex bg-background flex-col justify-between">
